...
void setup() {
    ...
    // begin program output the program I am.
    Serial.println("Starting arduino-nano-xiaomi-step-ws2812-stepombouw.nl.ino");
    Serial.println("https://www.stepombouw.nl/software/broncode-github");
    Serial.println("V 3.1 = Documentation");
    Serial.println("V 3.2 = Update ws2812 for feedback about power outage");
...
int setThrottle(int percentage) {
  ...
  // set percentage --> neopixel
  pixels.setPixelColor(0, pixels.Color(0, (254/(100*percentage)), 0)); // green
  pixels.show(); // Send the updated pixel colors to the hardware.
}
